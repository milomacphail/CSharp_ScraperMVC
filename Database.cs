...
namespace CSharp_Scraper
{
    class Database
    {
        ...
        {
            string lastScrape = @"IF EXISTS(SELECT* FROM StockTable WHERE Stock_Symbol = @stock_symbol)
                                    UPDATE StockTable
                                ...
                                ELSE 
                                    INSERT INTO StockTable VALUES (@time_scraped, @stock_symbol, @last_price, @change, @change_percent, @volume, @shares, @average_volume, @market_cap);";
